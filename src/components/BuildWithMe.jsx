    ...
    <div className='form-container m-[10px 20px]  md:mx-auto flex justify-center'>
      ...
      <form onSubmit={submit} className="md:w-[45%]">
        <div className="grid grid-flow-row gap-1 m-3">
          ...
          <input type="text" name='fullname' placeholder='Enter Fullname'  className="md:h-[45px] px-3 text-[#0f112e] rounded-md bg-[#dcebe8]"/>
        </div>
        <div className="grid grid-flow-row gap-1 m-3">
          <label htmlFor="email">Email:</label>
          <input type="email" name='email' placeholder='Enter valid Email'  className="md:h-[45px] px-3 text-[#0f112e] rounded-md bg-[#dcebe8]"/>
        </div>
